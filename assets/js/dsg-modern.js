(function(){
  ...
  ready(function(){
    ...
    if(!document.querySelector('.dsg-fab-help')){var a=document.createElement('a');a.href='/admin_tutorial.php';a.className='btn dsg-fab-help';a.innerHTML='💡 Tutorial Admin';document.body.appendChild(a);}
